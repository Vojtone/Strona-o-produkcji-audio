	...
	<div id="wrapper">
		...
		<div id="content_2">
			...
			<h3>Akustyka</h3>
				...
				<ul>
							<li><a href="akustyka.php?subpage=czym_jest_akustyka">Czym jest akustyka?</a></li>
							<li><a href="akustyka.php?subpage=akustyka_pomieszczenia_odsluchowego">Akustyka pomieszczenia odsłuchowego</a></li>
							<li><a href="akustyka.php?subpage=czas_poglosu">Czas pogłosu	</a></li>
							<li><a href="akustyka.php?subpage=wady_akustyczne">Wady akustyczne</a></li>
				</ul>
			...
			<div id="content_artykul">
					...
					<?php
					$subpage = isset($_GET['subpage']) ? basename($_GET['subpage']) : 'czym_jest_akustyka';
					$file = 'akustyka/'.$subpage . '.html';
