	...
	<div id="wrapper">
		...
		<div id="content_2">
			...
			<h3>Sprzęt</h3>
				...
				<ul>
						<li><a href="sprzet.php?subpage=czego_potrzebuje_na_poczatek">Czego potrzebuję na początek?</a></li>
						<li><a href="sprzet.php?subpage=jakie_glosniki_kupic">Jakie głośniki kupić?</a></li>
						<li><a href="sprzet.php?subpage=wybor_interfejsu_audio">Wybór interfejsu audio</a></li>
						<li><a href="sprzet.php?subpage=wybor_klawiatury_sterujacej">Wybór klawiatury sterującej</a></li>
				</ul>
			...
			<div id="content_artykul">
					...
					<?php
					$subpage = isset($_GET['subpage']) ? basename($_GET['subpage']) : 'czego_potrzebuje_na_poczatek';
					$file = 'sprzet/'.$subpage . '.html';
