	...
	<div id="wrapper">
		...
		<div id="content_2">
			...
			<h3>Nagrywanie</h3>
				...
				<ul>
						<li><a href="nagrywanie.php?subpage=czym_jest_dobre_nagranie">Czym jest dobre nagranie?</a></li>
						<li><a href="nagrywanie.php?subpage=dobor_mikrofonu">Dobór mikrofonu</a></li>
						<li><a href="nagrywanie.php?subpage=efekt_zblizeniowy">Efekt zbliżeniowy</a></li>
						<li><a href="nagrywanie.php?subpage=kierunkowosc">Kierunkowość</a></li>
				</ul>
			...
			<div id="content_artykul">
					...
					<?php
					$subpage = isset($_GET['subpage']) ? basename($_GET['subpage']) : 'przygotowanie_do_nagran';
					$file = 'nagrywanie/'.$subpage . '.html';
