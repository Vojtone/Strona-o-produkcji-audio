	...
	<div id="wrapper">
		...
		<div id="content_2">
			...
			<h3>Miks</h3>
				...
				<ul>
							<li><a href="miks.php?subpage=cele_miksu">Cele miksu</a></li>
							<li><a href="miks.php?subpage=procesory_dynamiki-kompresor">Procesory dynamiki - kompresor</a></li>
							<li><a href="miks.php?subpage=cele_korekcji">Cele korekcji</a></li>
							<li><a href="miks.php?subpage=panoramowanie">Panoramowanie</a></li>
							<li><a href="miks.php?subpage=przekazanie_emocji">Przekazanie emocji</a></li>
							<li><a href="miks.php?subpage=sciezki_referencyjne">Ścieżki referencyjne</a></li>
				</ul>
			...
			<div id="content_artykul">
					...
					<?php
					$subpage = isset($_GET['subpage']) ? basename($_GET['subpage']) : 'cele_miksu';
					$file = 'miks/'.$subpage . '.html';
